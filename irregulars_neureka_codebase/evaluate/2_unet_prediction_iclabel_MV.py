...
saved_predictions = './irregulars-neureka-codebase/evaluate/evaluation/prediction_test_iclabel.h5' # File to store the prediction
network_path = './irregulars-neureka-codebase/evaluate/attention_unet_iclabel.h5' # Path to trained weights
