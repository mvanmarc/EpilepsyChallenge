...
from library import nedc, wiener
...
saved_predictions = './irregulars-neureka-codebase/evaluate/evaluation/prediction_test_wiener.h5' # File to store the prediction
network_path = './irregulars-neureka-codebase/evaluate/attention_unet_wiener.h5' # Path to trained weights
